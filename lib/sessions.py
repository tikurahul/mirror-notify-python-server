...
class LilCookies:
    ...
    def __init__(self, handler, cookie_secret):
        ...
        if len(cookie_secret) < 45:
            raise ValueError("cookie_secret should at least be 45 characters long, but got `%s`" % cookie_secret)
    ...
    def set_cookie(self, name, value, domain=None, expires=None, path="/",
        ...
        # The 2 lines below were not in Tornado.
        # Instead, they output all their cookies to the headers at once before a response flush.
